...
impl CompiledAtlas {
    ...
    pub fn select_lexicographic(
        ...
        let resolution = PolicyResolution {
            id: "MPR_INLINE".into(),
            scope: mf_core::PolicyScope::Global,
            applied_policy_ids: vec!["INLINE".into()],
            conflicts: Vec::new(),
            trace: mf_core::PolicyTrace {
                id: "MPT_INLINE".into(),
                steps: vec!["inline optimizer policy".into()],
            },
            optimizer: mf_core::OptimizerPolicyConfig {
                optimizer_policy,
            ...
            evaluator: mf_core::EvaluatorPolicyConfig {
                evidence_preference: mf_core::EvidencePreference::RecomputeIfSupported,
                allow_approximation: true,
                unsupported_mode: mf_core::UnsupportedHandlingMode::Permit,
                require_symbolic_fidelity_route: false,
                prefer_comp_replay: true,
            },
            replay_cache: mf_core::ReplayCachePolicyConfig {
                replay_allowed: true,
                ...
                trust_class: mf_core::ReplayTrustClass::ExactPolicyOnly,
            },
            report: mf_core::ReportPolicyConfig {
            ...
            verdict: mf_core::PolicyVerdict::Applied,
        };
