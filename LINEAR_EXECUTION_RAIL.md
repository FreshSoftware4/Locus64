...
- Complement burden law now has a focused regression proving receipt-only complement claims are malformed; complement admissibility burdens are constitutionalized before deeper bundle reroute work.
...
- Policy precedence now emits deterministic receipt content across equivalent registry orderings by breaking equal-score resolver ties with stable policy identity.
