use mf_core::{ComboPack, HeaderEnvelope, SurfaceKind};
...
pub fn qk0_to_document(
    input: &str,
    combo_pack: &ComboPack,
) -> Result<(HeaderEnvelope, mf_core::QaDocument), Qk0Error> {
...
mod tests {
    ...
    fn qk0_gate_roundtrip() {
        let pack = ComboPack {
            id: "COMBO".into(),
            version: "1".into(),
            pack: mf_core::SupportedPack::PackA,
