...
pub fn resolve_policy_graph(
    ...
    for policy in applicable {
        ...
        if let Some(config) = &policy.optimizer {
            if policy.kind != mf_core::PolicyKind::Optimizer && strict {
        ...
        if let Some(config) = &policy.evaluator {
            if policy.kind != mf_core::PolicyKind::Evaluator && strict {
                conflicts.push(conflict_for(
                    &policy,
        ...
        if let Some(config) = &policy.replay_cache {
            if policy.kind != mf_core::PolicyKind::ReplayCache && strict {
        ...
        if let Some(config) = &policy.report {
            if policy.kind != mf_core::PolicyKind::ReportExport && strict {
...
pub fn build_execution_manifest(
    ...
    ExecutionManifest {
        ...
        policy_manifest: mf_core::PolicyManifest {
...
fn builtin_policies() -> Vec<MechanizationPolicyObject> {
    vec![
        MechanizationPolicyObject {
            ...
            kind: mf_core::PolicyKind::Optimizer,
        ...
        MechanizationPolicyObject {
            ...
            kind: mf_core::PolicyKind::Evaluator,
            scope: PolicyScope::Global,
            extends: None,
            optimizer: None,
        ...
        MechanizationPolicyObject {
            ...
            kind: mf_core::PolicyKind::ReplayCache,
            scope: PolicyScope::Global,
            extends: None,
            optimizer: None,
            evaluator: None,
        ...
        MechanizationPolicyObject {
            ...
            kind: mf_core::PolicyKind::ReportExport,
            scope: PolicyScope::Global,
            extends: None,
            optimizer: None,
            evaluator: None,
...
mod tests {
    use super::*;
    use mf_core::RegistryLookup;

    #[derive(Default)]
    struct EmptyRegistry;
    impl RegistryLookup for EmptyRegistry {
        fn get_object(&self, _: &str) -> Option<mf_core::QcObject> {
            None
        }
        fn get_regime(&self, _: &str) -> Option<mf_core::RegimePack> {
            None
        }
        fn get_bridge(&self, _: &str) -> Option<mf_core::BridgeContract> {
            None
        }
        fn get_proof_shape(&self, _: &str) -> Option<mf_core::ProofShape> {
            None
        }
        fn get_atlas_cell(&self, _: &str) -> Option<mf_core::AtlasCell> {
            None
        }
        fn get_mechanization_package(&self, _: &str) -> Option<mf_core::MechanizationPackage> {
            None
        }
        fn get_theorem_spec(&self, _: &str) -> Option<mf_core::TheoremSpec> {
            None
        }
        fn get_obligation(&self, _: &str) -> Option<mf_core::Obligation> {
            None
        }
        fn get_target_profile(&self, _: &str) -> Option<mf_core::TargetProfile> {
            None
        }
        fn get_route_ledger(&self, _: &str) -> Option<mf_core::RouteLedger> {
            None
        }
        fn get_certificate(&self, _: &str) -> Option<mf_core::Certificate> {
            None
        }
        fn get_campaign(&self, _: &str) -> Option<mf_core::Campaign> {
            None
        }
        fn get_campaign_portfolio(&self, _: &str) -> Option<mf_core::CampaignPortfolio> {
            None
        }
        fn get_route_class(&self, _: &str) -> Option<mf_core::RouteClass> {
            None
        }
        fn get_atlas_deficiency(&self, _: &str) -> Option<mf_core::AtlasDeficiency> {
            None
        }
        fn atlas_deficiencies(&self) -> Vec<mf_core::AtlasDeficiency> {
            Vec::new()
        }
        fn get_adequacy_clause(&self, _: &str) -> Option<mf_core::AdequacyClause> {
            None
        }
        fn adequacy_clauses(&self) -> Vec<mf_core::AdequacyClause> {
            Vec::new()
        }
        fn get_codebook_pack(&self, _: &str) -> Option<mf_core::CodebookPack> {
            None
        }
        fn get_glyph_pack(&self, _: &str) -> Option<mf_core::GlyphPack> {
            None
        }
        fn get_combo_pack(&self, _: &str) -> Option<mf_core::ComboPack> {
            None
        }
        fn get_projection_policy(&self, _: &str) -> Option<mf_core::ProjectionPolicy> {
            None
        }
        fn get_alias_expansion_policy(&self, _: &str) -> Option<mf_core::AliasExpansionPolicy> {
            None
        }
        fn get_surface_policy(&self, _: &str) -> Option<mf_core::SurfacePolicy> {
            None
        }
        fn get_capability_matrix(&self, _: &str) -> Option<mf_core::CapabilityMatrix> {
            None
        }
        fn get_roundtrip_report(&self, _: &str) -> Option<mf_core::RoundTripReport> {
            None
        }
        fn get_transform_receipt(&self, _: &str) -> Option<mf_core::FormatTransformReceipt> {
            None
        }
        fn get_surface_deficiency(&self, _: &str) -> Option<mf_core::SurfaceDeficiency> {
            None
        }
        ...
        fn find_equivalence_class(&self, _: &str, _: &str) -> Option<mf_core::EquivalenceClass> {
            None
        }
