use l64_core::{HeaderEnvelope, QaDocument, QaEntry, SurfaceKind};
use thiserror::Error;
...
mod tests {
    ...
    fn qc0_roundtrips_imported_claim_entries() {
        ...
        let document = QaDocument {
            entries: vec![
                QaEntry::ClaimPacket(l64_core::ClaimPacket {
                    id: "CLM_T".into(),
                    claim_class: l64_core::ClaimClass::Kernel,
                    authority_state: l64_core::AuthorityState::Evidence,
                    target_sector: "kernel-claim".into(),
                    statement: "test".into(),
                    assumptions: vec!["A1".into()],
                    open_caveats: vec![],
                }),
                QaEntry::EvidenceContract(l64_core::EvidenceContract {
                    id: "ECT_T".into(),
                    required_evidence_kinds: vec!["kernel-claim".into()],
                    required_benchmark_roles: vec![l64_core::BenchmarkRole::TargetCase],
                    requires_stress: false,
                    requires_challenge: false,
                    admissibility_thresholds: vec!["stable".into()],
                    promotion_ceiling: l64_core::CertificationVerdict::Certified,
                }),
                QaEntry::BenchmarkReceipt(l64_core::BenchmarkReceipt {
                    id: "BMR_T".into(),
                    claim_packet_id: "CLM_T".into(),
                    role: l64_core::BenchmarkRole::TargetCase,
                    verdict: l64_core::CertificationVerdict::Certified,
                    metrics: std::collections::BTreeMap::new(),
                    reproducibility_ref: "RPK_T".into(),
                }),
                QaEntry::ChallengeReceipt(l64_core::ChallengeReceipt {
                    id: "CHR_T".into(),
                    claim_packet_id: "CLM_T".into(),
                    grounds: vec!["g".into()],
                    required_response: "r".into(),
                    status: l64_core::ChallengeStatus::Addressed,
                }),
                QaEntry::ReproducibilityPacket(l64_core::ReproducibilityPacket {
                    id: "RPK_T".into(),
                    claim_packet_id: "CLM_T".into(),
